...
| :---: | :--- | :--- |
| **C1 - C2** | 成交-买入 | 买入成交笔数、买入成交量 |
| **C3 - C4** | 成交-卖出 | 卖出成交笔数、卖出成交量 |
| **C5 - C6** | 主动成交-买 | 主动买入成交笔数、主动买入成交量 |
| **C7 - C8** | 主动成交-卖 | 主动卖出成交笔数、主动卖出成交量 |
| **C9 - C10** | 限价委托 | 限价买入委托笔数、限价卖出委托笔数 |
| **C11 - C12** | 市价委托 | 市价买入委托笔数、市价卖出委托笔数 |
| **C13 - C14** | 委托量 | 限价买入委托量、限价卖出委托量 |
| **C15** | 撤单 | 撤单笔数 (Cancel Orders) |
